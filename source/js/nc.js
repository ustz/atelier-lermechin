...
***************************************************************
* AUTHOR : NCodeArt
* PROJECT : Show Coming Soon Template
...
; (function () {
	...
	jQuery(document).ready(function ($) {
		...
		$o.osection = $("[data-osection='true']").length > 0 && $o.r ? $("[data-osection='true']") : false;
		...
		if ($o.r) {
			...
			if ($o.osection) {
				$(".olink").on("click", function() {
					var pageObj = {
						pageType : $(this).attr("data-pgtype"),
						pageUrl : $(this).attr("data-page"),
						homePage : ".nc-intro-section",
						onePage : ".nc-other-section.nc-onepage",
						singlePage : ".nc-other-section.nc-singlepage",
						closeButton : ".nc-other-section > .nc-close"
					}
					...
					if(pageObj.pageType == "nc-onepage"){
						...
						$(pageObj.homePage).removeClass("nc-active");
						$(pageObj.singlePage).addClass("nc-active");
					}
